...
const CommunityMangement = () => {
  return (
    <div
      className="w-full h-full bg-[#EDECF6] md:py-[100px] px-4"
      id="community-management">
      <div className="container mx-auto">
        <div className="md:w-[60%] mx-auto flex-col-reverse md:flex-row gap-[40px] md:gap-[100px] items-start justify-center">
