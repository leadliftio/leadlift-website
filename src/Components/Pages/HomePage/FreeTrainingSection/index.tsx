    ...
    <div className="w-full px-[20px] md:px-[150px] py-[64px] md:py-[100px] flex flex-col md:flex-row gap-[120px] bg-white">
      <div className="section-content flex-1">
        ...
        <p className="font-openSans text-base text-brandBlue leading-[28px] mb-[40px]">
          ...
          media that resonates with your audience and positions you as a leader
          in your field.
        </p>
      ...
      <div className="section-graphics flex-1">
        <div className="container w-full h-full flex items-center justify-center">
          <div className="relative w-full h-full">
            <div className="blob-bg w-[60%] md:w-[375px] h-[456px] flex-shrink-0 bg-brandLightPurple rounded-[20px] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]" />
            <div className="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] w-[489px] h-[296px]">
              <img
                src={trainingImage}
                alt=""
                className="rounded-[8px] w-full"
              />
              <div className="absolute top-[240px] left-[-30px]">
                <GreenDotsGroup />
              </div>
              <div className="absolute top-[0px] left-[489px]">
                <BlueDotsGroup />
              </div>
            </div>
          </div>
